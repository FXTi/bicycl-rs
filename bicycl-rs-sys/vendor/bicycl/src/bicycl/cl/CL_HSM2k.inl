 ...
 */
#ifndef BICYCL_CL_CL_HSM2K_INL
#define BICYCL_CL_CL_HSM2K_INL

#include "CL_HSM2k.hpp"

namespace BICYCL
{
  inline
  CL_HSM2k::CL_HSM2k (const Mpz &N, size_t k, const CL_Params params)
    : N_(N),
      k_(k),
  ...
  */
  inline
  CL_HSM2k::CL_HSM2k (size_t N_nbits, size_t k, RandGen &randgen,
                      const CL_Params params)
    : CL_HSM2k (random_N (randgen, N_nbits), k, params)
  {
  }
  ...
  */
  inline
  CL_HSM2k::CL_HSM2k (SecLevel seclevel, size_t k, RandGen &randgen,
                      const CL_Params params)
    : CL_HSM2k (seclevel.RSA_modulus_bitsize(), k, randgen, params)
  {
  }
  ...
  /* */
  inline
  size_t CL_HSM2k::lambda_distance () const
  {
    return distance_;
  }
  ...
  */
  ...
  /* */
  inline CL_HSM2k::CipherText
  CL_HSM2k::addscal_ciphertexts(const PublicKey & pk,
                                const CipherText & ca,
                                const CipherText & cb,
                                const Mpz & s,
                                RandGen & randgen) const
