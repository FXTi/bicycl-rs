 ...
 */
#ifndef BICYCL_CL_CL_HSM2K_HPP
#define BICYCL_CL_CL_HSM2K_HPP
...
namespace BICYCL
{
  ...
  class CL_HSM2k
  {
    ...
    public:
       ...
       */
      CL_HSM2k (const Mpz &N, size_t k, const CL_Params params={});
      /**
       ...
       */
      CL_HSM2k (size_t N_bits, size_t k, RandGen &randgen,
